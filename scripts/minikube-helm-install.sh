...
helm upgrade --install cykube -n cykube --create-namespace --set token="$TOKEN" --set tag="$TAG" --set apiUrl="https://dev.cykubed.com/api"  --set cache.storageClass=standard --set imagePullPolicy=IfNotPresent ./chart
